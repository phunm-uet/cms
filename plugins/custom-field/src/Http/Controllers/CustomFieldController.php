...
class CustomFieldController extends Controller
{
    ...
    public function getList(CustomFieldDataTable $dataTable)
    {
        ...
        return $dataTable->render('custom-field::list');
    }
    ...
    public function getCreate()
    {
        ...
        Assets::addJavascriptsDirectly('vendor/core/plugins/custom-field/js/edit-field-group.js');
    ...
    public function postCreate(CreateFieldGroupRequest $request)
    {
        ...
        $field_group->created_by = Sentinel::getUser()->getUserId();
        $field_group->updated_by = Sentinel::getUser()->getUserId();
    ...
    public function getDelete($id, Request $request)
    {
        try {
            ...
            return ['error' => false, 'message' => trans('custom-field::field-groups.deleted')];
        } catch (Exception $ex) {
            return ['error' => true, 'message' => trans('custom-field::field-groups.cannot_delete')];
        }
    }
    ...
    public function postDeleteMany(Request $request)
    {
        ...
        if (empty($ids)) {
            return ['error' => true, 'message' => trans('custom-field::field-groups.notices.no_select')];
        }
        ...
        return ['error' => false, 'message' => trans('custom-field::field-groups.field_group_deleted')];
    }
    ...
    public function postChangeStatus(Request $request)
    {
        ...
        return ['error' => false, 'status' => $request->input('status'), 'message' => trans('custom-field::field-groups.notices.update_success_message')];
    }
}
