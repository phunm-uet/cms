                        ...
                        <div class="main-form">
                            <div class="form-wrap">
                                <div class="form-group">
                                    ...
                                    <select name="language_id" id="language_id" class="form-control select-search-full">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" id="lang_name" type="text" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="locale" id="lang_locale" type="text" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="code" id="lang_code" type="text" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <p>
                                        <label><input name="rtl" class="is_ltr" type="radio" value="0" checked="checked"> {{ trans('language::language.left_to_right') }}</label> &nbsp;
                                        <label><input name="rtl" class="is_rtl" type="radio" value="1"> {{ trans('language::language.right_to_left') }}</label>
                                    </p>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="flag_list" id="flag_list" class="form-control select-search-language">
                                        <option></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="lang_order" id="lang_order" type="number" value="0" class="form-control">
                                ...
                                <ul class="list-item-checkbox">
                                    @foreach (Language::getActiveLanguage() as $language)
                                        @if (!$language->is_default)
                                            <li>
                                                <input type="checkbox" class="icheck" name="language_hide_languages[]" value="{{ $language->id }}" id="language_hide_languages_item-{{ $language->code }}" @if (in_array($language->id, json_decode(setting('language_hide_languages', '[]'), true))) checked="checked" @endif>
                                                <label for="language_hide_languages_item-{{ $language->code }}">{{ $language->name }}</label>
                                            </li>
                                        @endif
                                    @endforeach
                                </ul>
