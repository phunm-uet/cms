...
class Language
{
    ...
    public function getSupportedLocales()
    {
        ...
        foreach ($languages as $language) {
            if (!in_array($language->id, json_decode(setting('language_hide_languages', '[]'), true))) {
    ...
    {
        return $this->languageRepository->getActiveLanguage();
    }
    ...
    {
        return apply_filters(LANGUAGE_FILTER_MODEL_USING_MULTI_LANGUAGE, [POST_MODULE_SCREEN_NAME, PAGE_MODULE_SCREEN_NAME, CATEGORY_MODULE_SCREEN_NAME, MENU_MODULE_SCREEN_NAME, TAG_MODULE_SCREEN_NAME]);
    }
    ...
    {
        $meta = app(LanguageMetaInterface::class)->getModel()->where('origin', '=', $unique_key);
        if ($id != Request::input('from')) {
            $meta = $meta->where('content_id', '!=', $id);
        }
        return $meta->pluck('content_id', 'code')->all();
    }
    ...
    {
        return $this->supportedLocales[$this->getCurrentLocale()]['is_rtl'];
    }
    ...
    {
        return $this->supportedLocales[$this->getCurrentLocale()]['code'];
    }
    ...
    {
        return $this->supportedLocales[$this->getDefaultLocale()]['code'];
    }
     ...
     * @author Sang Nguyen
     */
    public function getCurrentDataLanguage()
    {
