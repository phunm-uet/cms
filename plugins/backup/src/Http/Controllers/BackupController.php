...
class BackupController extends Controller
{
    ...
    public function getIndex()
    {
        ...
        Assets::addJavascriptsDirectly('vendor/core/plugins/backup/js/backup.js');
    ...
    public function getDelete($folder)
    {
        try {
            ...
            return ['error' => false, 'message' => trans('backup::backup.delete_backup_success')];
        } catch (Exception $ex) {
            return ['error' => true, 'message' => $ex->getMessage()];
        }
    }
    ...
    public function getRestore($folder, Request $request)
    {
        try {
            ...
            return ['error' => false, 'message' => trans('backup::backup.restore_backup_success')];
        } catch (Exception $ex) {
            return ['error' => true, 'message' => $ex->getMessage()];
        }
    }
