...
namespace Botble\Menu\Http\DataTables;

use Botble\Base\Http\DataTables\DataTableAbstract;
use Botble\Menu\Repositories\Interfaces\MenuInterface;

class MenuDataTable extends DataTableAbstract
{
    /**
    ...
    public function query()
    {
        ...
        return $this->applyScopes(apply_filters(BASE_FILTER_DATATABLES_QUERY, $query, $model, MENU_MODULE_SCREEN_NAME));
    }
    ...
    public function buttons()
    {
        ...
        return apply_filters(BASE_FILTER_DATATABLES_BUTTONS, $buttons, MENU_MODULE_SCREEN_NAME);
    }
