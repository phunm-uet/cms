var Dashboard = function () {
    return {
        loadWidget: function (el, url, data, callback) {
            Botble.blockUI({
                target: el,
                iconOnly: true,
                overlayColor: 'none'
        ...
        init: function () {
                ...
                list_widgets.on('click', '.page_next, .page_previous', function (e) {
                    e.preventDefault();
                    Dashboard.loadWidget($(this).closest('.portlet').find('.portlet-body'), $(this).prop('href'));
                });
                ...
                list_widgets.on('change', '.number_record .numb', function (e) {
                    ...
                    if (!isNaN(paginate)) {
                        Dashboard.loadWidget($(this).closest('.portlet').find('.portlet-body'), $(this).closest('.widget_item').attr('data-url'), {paginate: paginate});
                    } else {
                ...
                $(document).on('click', '.portlet > .portlet-title > .tools > a.reload', function (e) {
                    e.preventDefault();
                    Dashboard.loadWidget($(this).closest('.portlet').find('.portlet-body'), $(this).closest('.widget_item').attr('data-url'));
                });
