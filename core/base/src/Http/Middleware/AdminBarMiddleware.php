...
class AdminBarMiddleware
{
    ...
    public function modifyResponse(Request $request, Response $response)
    {
        ...
        if (is_in_admin() || $app->runningInConsole() || $this->isDebugbarRequest() || $request->ajax()) {
            return $response;
        }
    ...
    {
        $css = '<link rel="stylesheet" href="' . asset('vendor/core/css/admin-bar.css') . '"/>';
