        ...
        @if (Sentinel::check())
            <li class="dropdown dropdown-user">
                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                    <img alt="{{ Sentinel::getUser()->getFullName() }}" class="img-circle" src="{{ url(Sentinel::getUser()->getProfileImage()) }}" />
                    <span class="username username-hide-on-mobile"> {{ Sentinel::getUser()->getFullName() }} </span>
                    <i class="fa fa-angle-down"></i>
                </a>
