...
if (!function_exists('get_meta_data')) {
     ...
     * @author Sang Nguyen
     */
    function get_meta_data($id, $key, $screen, $single = false)
    {
        return MetaBox::getMetaData($id, $key, $screen, $single);
    }
}
...
if (!function_exists('get_meta')) {
     ...
     * @author Sang Nguyen
     */
    function get_meta($id, $key, $screen)
    {
        return MetaBox::getMeta($id, $key, $screen);
    }
}
