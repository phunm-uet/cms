...
class FeatureController extends Controller
{
    ...
    public function getList()
    {
        ...
        $features = $this->permissionRepository->getVisibleFeatures();
    ...
    /**
     * Edit Function (Don't remove it, it will keep not method allow exception
     * @author Sang Nguyen
     */
    ...
    public function postEdit(Request $request)
    {
        ...
        if (is_array($features) && count($features) > 0) {
            foreach ($features as $feature) {
                $this->featureRepository->firstOrCreate(['feature_id' => $feature]);
            }
        }
