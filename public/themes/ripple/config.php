...
return [
    ...
    'events' => [
        ...
        'beforeRenderTheme' => function ($theme) {
            ...
            $theme->asset()->container('footer')->usePath()->add('bootstrap-js', 'vendor/bootstrap/dist/js/bootstrap.min.js');
            $theme->asset()->container('footer')->usePath()->add('overflow-text', 'plugins/overflow-text.js');
            $theme->asset()->container('footer')->usePath()->add('jquery.parallax', 'plugins/jquery.parallax-1.1.3.js');
            $theme->asset()->container('footer')->usePath()->add('custom', 'js/custom.min.js');
            $theme->asset()->container('footer')->usePath()->add('ripple.js', 'js/ripple.js');
            ...
            $theme->asset()->container('footer')->usePath()->add('owl-carousel', 'plugins/owl-carousel/owl.carousel.min.js', ['jquery']);
            ...
            $theme->asset()->usePath()->add('owl-carousel', 'plugins/owl-carousel/owl.carousel.css');
            $theme->asset()->usePath()->add('owl-theme', 'plugins/owl-carousel/owl.theme.css');
